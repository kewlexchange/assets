...
func main() {
	...
	filePath := "/Users/Hp/Desktop/nfts-main/chiliz/index.json"
	...
	for i := range swapDefault.Tokens {
		...
		var NewLogoURL = fmt.Sprintf("https://raw.githubusercontent.com/imonai/nfts/main/chiliz/tokens/%s/logo.svg", ContractAddress)
